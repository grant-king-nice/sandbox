...
public class POCComp2Renderer extends Renderer {

	static private String requireJSPath = "/delegate/requirejs/js/poc/components/com/ccih/example/component2/component";
	
	@Override
	public void encodeBegin(FacesContext context, UIComponent component) throws IOException {
		ResponseWriter writer = context.getResponseWriter();
		writer.startElement("div", null);
		writer.writeAttribute("id", "component2", null);
	...
	public void encodeEnd(FacesContext context, UIComponent component) throws IOException {
		...
		writer.write("var parentContainer2 = $(\"#component2\");");
